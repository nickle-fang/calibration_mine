...
def callback(img):
    ...
    #将图像裁切为左右两图
    img_left = equal_img[0:480, 0:640]
    img_right = equal_img[0:480, 640:1280]
    ...
    # 调用发布函数发布数据
    pub_left.publish(img_msg_left)
    pub_right.publish(img_msg_right)
...
if __name__ == "__main__":
    ...
    pub_left = rospy.Publisher("img_left", Image, queue_size=1)
    pub_right = rospy.Publisher("img_right", Image, queue_size=1)
